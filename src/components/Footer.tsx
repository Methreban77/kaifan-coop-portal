      ...
      <div className="container mx-auto px-4 py-10 grid gap-8 md:grid-cols-3">
        <div>
          ...
          <p className="text-sm text-muted-foreground max-w-xs">
            {lang === "ar" ? "نخدم مجتمع كيفان منذ عام 1962." : "Serving the Kaifan community since 1962."}
          </p>
        </div>
        <div>
          <h4 className="font-semibold mb-3">{t("footer.contact")}</h4>
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li className="flex items-center gap-2"><MapPin className="h-4 w-4 shrink-0" /> {t("footer.address")}</li>
            <li className="flex items-center gap-2">
              ...
              <a href="https://wa.me/96566828833" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
                +965 6682 8833
              </a>
            </li>
            <li className="flex items-center gap-2">
              <Mail className="h-4 w-4 shrink-0" />
              <a href="mailto:kaifan_coop@kaifancoop.net" className="hover:text-primary transition-colors">
                kaifan_coop@kaifancoop.net
              </a>
            </li>
            <li className="flex items-center gap-2">
              {/* Instagram icon */}
              ...
              <a href="https://www.instagram.com/kaifan_coop_q8" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
                @kaifan_coop_q8
              </a>
            </li>
          </ul>
